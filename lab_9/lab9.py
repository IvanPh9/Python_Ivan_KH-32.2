...
if file_1_w:
    file_1_w.write("Meet me in the lobby I've been up for twenty four I wanna Dance I wanna party Do it like no one before")
    print(f"Information was succesfully added to {file1_name}")
    file_1_w.close();
    print(f"File {file1_name} was closed!")
if file_2_w:
    file_2_w.write("I took the Eurostar from Paris And you know what fucking for I wanna dance I wanna party Do it like no one before")
